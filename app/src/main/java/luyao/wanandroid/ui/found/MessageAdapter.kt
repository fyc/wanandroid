 ...
 * on 2018/3/14 15:52
 */
class MessageAdapter(layoutResId: Int = R.layout.item_found_message_constraint) : BaseBindAdapter<MessageData>(layoutResId, BR.messageData) {

    override fun convert(helper: BindViewHolder, item: MessageData) {
        super.convert(helper, item)

//        helper.setText(R.id.titleName, item.name)
